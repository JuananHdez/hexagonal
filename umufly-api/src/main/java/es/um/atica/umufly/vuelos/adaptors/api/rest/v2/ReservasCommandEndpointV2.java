...
import es.um.atica.umufly.vuelos.application.usecase.crearreservas.CreaReservasCommand;
import es.um.atica.umufly.vuelos.application.usecase.crearreservas.CreaReservasCommandHandler;
...
public class ReservasCommandEndpointV2 {
	...
	private final CreaReservasCommandHandler creaReservasCommandHandler;
	...
	public ReservasCommandEndpointV2( CreaReservasCommandHandler creaReservasCommandHandler, CancelarReservasCommandHandler cancelarReservasCommandHandler, ReservasModelAssemblerV2 reservasModelAssembler,
			AuthService authService ) {
		this.creaReservasCommandHandler = creaReservasCommandHandler;
	...
	public ReservaVueloDTO creaReserva( @RequestHeader( name = "UMU-Usuario", required = true ) String usuario, @RequestBody @Valid ReservaVueloDTO nuevaReservaVuelo ) throws Exception {
		return reservasModelAssembler.toModel( creaReservasCommandHandler.handle( CreaReservasCommand.of( authService.parseUserHeader( usuario ), nuevaReservaVuelo.getVuelo().getId(), ClaseAsientoReserva.valueOf( nuevaReservaVuelo.getClaseAsiento().toString() ),
