...
public class ReservasQueryEndpointV2 {
	...
	public ReservasQueryEndpointV2( ObtenerReservasQueryHandler obtenerReservasQueryHandler, ListarReservasQueryHandler listarReservasQueryHandler, ReservasModelAssemblerV2 reservasModelAssembler,
			PagedResourcesAssembler<ReservaVuelo> pagedResourcesAssembler,
	...
	public ReservaVueloDTO getReserva( @RequestHeader( name = "UMU-Usuario", required = true ) String usuario, @PathVariable( "idReserva" ) UUID idReserva ) throws Exception {
		return reservasModelAssembler.toModel( obtenerReservasQueryHandler.handle( ObtenerReservaQuery.of( authService.parseUserHeader( usuario ), idReserva ) ) );
	}
