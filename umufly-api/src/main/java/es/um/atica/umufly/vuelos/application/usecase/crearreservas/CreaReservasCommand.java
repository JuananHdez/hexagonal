...
public class CreaReservasCommand extends SyncCommand<ReservaVuelo> {
	...
	private CreaReservasCommand( DocumentoIdentidad documentoIdentidadTitular, UUID idVuelo, ClaseAsientoReserva claseAsiento, Pasajero pasajero ) {
	...
	public static CreaReservasCommand of( DocumentoIdentidad documentoIdentidadTitular, UUID idVuelo, ClaseAsientoReserva claseAsiento, Pasajero pasajero ) {

		return new CreaReservasCommand( documentoIdentidadTitular, idVuelo, claseAsiento, pasajero );
	}
